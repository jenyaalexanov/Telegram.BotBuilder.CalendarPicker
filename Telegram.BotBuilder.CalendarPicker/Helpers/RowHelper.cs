...
namespace Telegram.BotBuilder.CalendarPicker.Helpers
{
    public static class RowHelper
    {
        ...
        public static InlineKeyboardButton[] BackToMonthPicker(in DateTime date) =>
        ...
        public static InlineKeyboardButton[] BackToYearPicker(in DateTime date) =>
            new InlineKeyboardButton[3]
            {
                ...
                InlineKeyboardButton.WithCallbackData(
                    "<",
                    $"{Constants.ChangeYearTo}{date.AddYears(-12).ToString(Constants.DateFormat)}"
                ),
                InlineKeyboardButton.WithCallbackData(
                    ">",
                    $"{Constants.ChangeYearTo}{date.AddYears(12).ToString(Constants.DateFormat)}"
